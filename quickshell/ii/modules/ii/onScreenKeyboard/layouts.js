...
const byName = {
    // Dvorak alt. intl. — mismas POSICIONES físicas que el US (keycodes idénticos),
    // solo cambian las etiquetas para que coincidan con lo que realmente se escribe.
    // Derivado de /usr/share/X11/xkb/symbols/us -> xkb_symbols "dvorak-alt-intl",
    // que hace include "us(dvorak)"; alt-intl solo agrega nivel 3 (AltGr), así que
    // los niveles 1 y 2 (normal y shift) son dvorak puro.
    "Dvorak (alt. intl.)": {
        name_short: "DV",
        description: "Dvorak - Full",
        comment: "Etiquetas dvorak sobre posiciones QWERTY",
        keys: [
            [
                // Fila de función: idéntica al US, no la toca ningún layout
            ...
            [
                // Fila de números: en dvorak solo cambian las dos últimas.
                // keycode 12 (donde QWERTY tiene "-") pasa a ser "[" y 13 pasa a "]"
                ...
                { keytype: "normal", label: "[", labelShift: "{", shape: "normal", keycode: 12 },
                { keytype: "normal", label: "]", labelShift: "}", shape: "normal", keycode: 13 },
                { keytype: "normal", label: "Backspace", shape: "expand", keycode: 14 }
            ],
            [
                // Fila superior dvorak: ' , . p y f g c r l / =
                { keytype: "normal", label: "Tab", shape: "tab", keycode: 15 },
                { keytype: "normal", label: "'", labelShift: '"', shape: "normal", keycode: 16 },
                { keytype: "normal", label: ",", labelShift: "<", shape: "normal", keycode: 17 },
                { keytype: "normal", label: ".", labelShift: ">", shape: "normal", keycode: 18 },
                { keytype: "normal", label: "p", labelShift: "P", shape: "normal", keycode: 19 },
                { keytype: "normal", label: "y", labelShift: "Y", shape: "normal", keycode: 20 },
                { keytype: "normal", label: "f", labelShift: "F", shape: "normal", keycode: 21 },
                { keytype: "normal", label: "g", labelShift: "G", shape: "normal", keycode: 22 },
                { keytype: "normal", label: "c", labelShift: "C", shape: "normal", keycode: 23 },
                { keytype: "normal", label: "r", labelShift: "R", shape: "normal", keycode: 24 },
                { keytype: "normal", label: "l", labelShift: "L", shape: "normal", keycode: 25 },
            ...
            [
                // Fila home dvorak: a o e u i d h t n s -
                // Los dos "spacer" son los que usa el US para compensar la falta de Caps
                { keytype: "spacer", label: "", shape: "empty" },
                { keytype: "spacer", label: "", shape: "empty" },
                { keytype: "normal", label: "a", labelShift: "A", shape: "normal", keycode: 30 },
                { keytype: "normal", label: "o", labelShift: "O", shape: "normal", keycode: 31 },
                { keytype: "normal", label: "e", labelShift: "E", shape: "normal", keycode: 32 },
                { keytype: "normal", label: "u", labelShift: "U", shape: "normal", keycode: 33 },
                { keytype: "normal", label: "i", labelShift: "I", shape: "normal", keycode: 34 },
                { keytype: "normal", label: "d", labelShift: "D", shape: "normal", keycode: 35 },
                { keytype: "normal", label: "h", labelShift: "H", shape: "normal", keycode: 36 },
                { keytype: "normal", label: "t", labelShift: "T", shape: "normal", keycode: 37 },
                { keytype: "normal", label: "n", labelShift: "N", shape: "normal", keycode: 38 },
                { keytype: "normal", label: "s", labelShift: "S", shape: "normal", keycode: 39 },
                { keytype: "normal", label: "-", labelShift: "_", shape: "normal", keycode: 40 },
                { keytype: "normal", label: "Enter", shape: "expand", keycode: 28 }
            ],
            [
                // Fila inferior dvorak: ; q j k x b m w v z
                { keytype: "modkey", label: "Shift", labelShift: "Shift", labelCaps: "Caps", shape: "shift", keycode: 42 },
                { keytype: "normal", label: ";", labelShift: ":", shape: "normal", keycode: 44 },
                { keytype: "normal", label: "q", labelShift: "Q", shape: "normal", keycode: 45 },
                { keytype: "normal", label: "j", labelShift: "J", shape: "normal", keycode: 46 },
                { keytype: "normal", label: "k", labelShift: "K", shape: "normal", keycode: 47 },
                { keytype: "normal", label: "x", labelShift: "X", shape: "normal", keycode: 48 },
                { keytype: "normal", label: "b", labelShift: "B", shape: "normal", keycode: 49 },
                { keytype: "normal", label: "m", labelShift: "M", shape: "normal", keycode: 50 },
                { keytype: "normal", label: "w", labelShift: "W", shape: "normal", keycode: 51 },
                { keytype: "normal", label: "v", labelShift: "V", shape: "normal", keycode: 52 },
                { keytype: "normal", label: "z", labelShift: "Z", shape: "normal", keycode: 53 },
                { keytype: "modkey", label: "Shift", labelShift: "Shift", labelCaps: "Caps", shape: "expand", keycode: 54 }
            ],
            [
                // Fila de modificadores: idéntica al US, son teclas sin letra
